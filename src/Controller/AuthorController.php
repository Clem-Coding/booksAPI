...
final class AuthorController extends AbstractController
{
     ...
     * @return JsonResponse
     */
    #[Route('/api/authors/{id}', name: 'detail-author', methods: ['GET'])]
    ...
    public function createAuthor(
        ...
        $jsonAuthor = $serializer->serialize($author, 'json', ['groups' => 'getAuthors']);
        $location = $this->generateUrl('detail-author', ['id' => $author->getId()], UrlGeneratorInterface::ABSOLUTE_URL);
     ...
     * @return JsonResponse
     */
    #[Route('/api/authors/{id}', name: 'delete-author', methods: ['DELETE'])]
